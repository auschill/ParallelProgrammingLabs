...
* First, we need to connect to the PYNQ board via a serial port terminal, such as MobaXterm, using the micro USB cable that also supplies power to the board, and we need to set some parameters like below:
